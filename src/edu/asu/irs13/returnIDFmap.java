...
public class returnIDFmap {


		public Map<Integer, Double> getTFIDF() throws CorruptIndexException, IOException
		{
			...
			MyComparator5 comp=new MyComparator5(IDFMap);
			MyComparator5 comp1=new MyComparator5(idfMap1);
...
//			getIDFstring(s);
		...
		public void getIDFstring(String s) throws CorruptIndexException, IOException {
...
//				System.out.println("done");
				...
				System.out.println("Relevant Similar documents are: \n");
				Set set = TREEMap.entrySet();
				// Get an iterator 
				Iterator i1 = set.iterator();
				int i2=0;
